                    ...
                    <div class="payment-book">
                        <div class="booking-box">
                            <div class="customer-information mb-2">
                                <h3 class="border-b pb-2 mb-2">PG Information</h3>
                                <form class="mb-2" method="post">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>PG Name</label>
                                                <input type="text" placeholder="PG Name" name="name">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-btn">
                                                <input type="submit" name="add-pg" value="Submit" class="nir-btn">
                                            </div>
                                        </div>
                                    </div>
                                </form>
